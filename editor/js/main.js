...
function loadSlider(key, data) {
  ...
  $("li#slider" + key + " #id").val(data.sliders[key].id);
  if (data.sliders[key].thumbnails) {
    $("li#slider" + key + " #thumbnails").prop('checked', true);
  }
  if (data.sliders[key].published) {
    $("li#slider" + key + " #published").prop('checked', true);
  }
}
